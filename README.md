...
> [!WARNING]
> **当前 0.1.1 为公开测试 / 内测体验版本，不是正式稳定版。**
>
> 目前提前开放下载，是为了让更多不同设备、系统、网络和地区参与实际测试。当前仍可能存在 Bug、界面适配、扫描结果、性能或客户端兼容问题。
>
> 如果发现异常，请到 GitHub Issues 留言反馈；建议附上版本、系统、客户端、复现步骤、截图或日志（请勿公开 Cloudflare API Token）。维护者会根据实际反馈持续测试、修复、优化和升级。
>
> **第一次使用请先看：[YunDongIP 0.1.1 完整文字教程](docs/USER-GUIDE.md)**
